				<div class="container-fluid">
					<div class="container w-75 text-dark mt-5">
						<form action="<?= base_url('Admin/insertKabupaten') ?>" method="POST">
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-8">
										<input type="number" class="form-control" id="jumlah_penduduk" name="jumlah_penduduk" placeholder="jumlah penduduk" required="">
									</div>
								</div>
							</div>
